...
{
    public partial class MoniRun270ZhuLianXu18 : Form
    {
        private MoniRun270ZhuLianXu18MoniBusiness moniBusiness;
        Code beforeCode = null;
        Code currentCode = null;
        public static readonly object LockPlayObj = new object();
        public MoniRun270ZhuLianXu18(Hou3Select350YiLouSetFormZhongParentBusiness business)
        {
            InitializeComponent();
            moniBusiness = new MoniRun270ZhuLianXu18MoniBusiness(CustomLogMethod, Hou2Selct27Three18SetFormBusiness.model350List, business);
        ...
        public void CustomLogMethod(string message, bool needPlay=false)
        {
            ...
            SetFormTxtValue();
            using (var writer = new StreamWriter("moni18期.txt", true))
            {
