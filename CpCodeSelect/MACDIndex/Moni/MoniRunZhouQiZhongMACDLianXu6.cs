...
{
    public partial class MoniRunZhouQiZhongMACDLianXu6 : Form
    {
        private Hou3Select350YiLouSetFormMACDLianXu6MoniBusiness moniBusiness;
        Code beforeCode = null;
        Code currentCode = null;
        public static readonly object LockPlayObj = new object();
        public MoniRunZhouQiZhongMACDLianXu6(Hou3Select350YiLouSetFormZhongParentBusiness business)
        {
            InitializeComponent();
            moniBusiness = new Hou3Select350YiLouSetFormMACDLianXu6MoniBusiness(CustomLogMethod, Hou3Select350YiLouSetFormMACDIndexBusiness.model350List, business);
        ...
        public void Run(Code code)
        {
            ...
            if (beforeCode == null || beforeCode.CodeQiHao != code.CodeQiHao)
            {
                ...
                //这里需要跑10期后再进行计算
                if (Hou3Select350YiLouSetFormMACDIndexBusiness.AllCode.Count > 280)
                {
