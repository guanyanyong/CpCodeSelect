...
{
    public partial class MoniRunZhouQiZhongXiaJiangXiaoFanTanLianXu6 : Form
    {
        private Hou3Select350YiLouSetFormZhouQiZhongXiaJiangXiaoFanTanLianXu6MoniBusiness moniBusiness;
        Code beforeCode = null;
        Code currentCode = null;
        public static readonly object LockPlayObj = new object();
        public MoniRunZhouQiZhongXiaJiangXiaoFanTanLianXu6(Hou3Select350YiLouSetFormZhongParentBusiness business)
        {
            InitializeComponent();
            moniBusiness = new Hou3Select350YiLouSetFormZhouQiZhongXiaJiangXiaoFanTanLianXu6MoniBusiness(CustomLogMethod, Hou3Select350YiLouSetFormXiaJiangXiaoFanTanBusiness.model350List, business);
        ...
        public void Run(Code code)
        {
            ...
            if (beforeCode == null || beforeCode.CodeQiHao != code.CodeQiHao)
            {
                ...
                //这里需要跑10期后再进行计算
                if (Hou3Select350YiLouSetFormXiaJiangXiaoFanTanBusiness.AllCode.Count > 280)
                {
        ...
        public void CustomLogMethod(string message, bool needPlay=false)
        {
            ...
            SetFormTxtValue();
            using (var writer = new StreamWriter("xiajiangxiaofantanmoni6期.txt", true))
            {
