...
{
    public partial class Hou3Select500YiLouSetFormScoreAndChuShou : Form
    {
        ...
        */
        ...
        public Hou3Select500YiLouSetFormScoreAndChuShou()
        {
            InitMoni();
            InitializeComponent();
            Init();
        ...
        private void InitData()
        {
            ...
            Hou3Select500YiLouSetFormScoreAndChuShouBusiness.InitData();
        }
        ...
        public void AnalySisCode(Code code, bool zhongHouDelete = false)
        {
            ...
            Hou3Select500YiLouSetFormScoreAndChuShouBusiness.InitCode(code, zhongHouDelete);
            InitOfferNumber();
            GenerateOfferNumber();
            SetForm();
        ...
        {
            var needAddList = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.Where(p => p.NeedZhong == false && p.GuaCount >= boFangYanhuaCount).OrderByDescending(p => p.GuaCount).ToList();
        ...
        private void SetFormInstance()
        {
            ...
            lock (Hou3Select500YiLouSetFormScoreAndChuShouBusiness.LockModel500List)
            {
                var list = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.ToList();
                if (list.Count > 0)
                {
        ...
        {
            bool needPlay = false;
            if (Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.Count > 500)
            {
                ...
                lock (Lock7ge5File)
                {
                    using (var writer = new StreamWriter(fileName, true))
                    {
                        var list = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.ToList().Where(p => p.NeedZhong == false).ToList();
                        if (list.Count > 0)
                        {
                            ...
                            {
                                needFlush = true;
                                Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.ToList().Where(p => p.GuaCount == maxNumber).ToList().ForEach(recode =>
                                {
        ...
        private async void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.RowIndex >= 0 && dataGridView1.Columns[e.ColumnIndex].Name == "Delete")
            {
                ...
                {
                    var model = row.DataBoundItem as Hou3Select500_ZhouQiZhongScore;
                    Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.Remove(model);
        ...
        private void BtnSelectClick()
        {
            ...
            var list = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.Where(p => p.NeedZhong == false && p.ZhouQiZhongHouGua >= number).OrderByDescending(p => p.ZhouQiZhongHouGua).ThenByDescending(p => p.IsZhouQiZhongHou).ToList();
            var number2 = numericUpDown2.Value;
            var guaCount = numericUpDown3.Value;
            if (number2 >= 0 && number <= number2)
            {
                list = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.Where(p => p.NeedZhong == false && p.ZhouQiZhongHouGua >= number && p.ZhouQiZhongHouGua <= number2).OrderByDescending(p => p.ZhouQiZhongHouGua).ThenByDescending(p => p.IsZhouQiZhongHou).ToList();
            }
            if (guaCount > -1)
            {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            while (true)
            {
                ...
                var AllCode = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.AllCode;
        ...
        private void btnTestCode_Click(object sender, EventArgs e)
        {
            ...
            Code code = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.code;
            ...
            KLine156ScoreCalc.CalcKLineHistoryList(model350, Hou3Select500YiLouSetFormScoreAndChuShouBusiness.AllCode, 100);
        ...
        private void DataLoadKLine()
        {
            if (currentCalcKLineDate == null)
            {
                ...
                {
                    //自动加载最新数据
                    var modelList = Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List;
                    if (modelList != null && modelList.Count > 0)
                    {
                        foreach (var record in modelList)
                        {
                            ...
                            Hou3Select500YiLouSetFormScoreAndChuShouBusiness.currentNeedCalcList.Add(currentCalcKLineDate);
                ...
                else
                {
                    ...
                    if (!string.IsNullOrEmpty(txtNumber))
                    {
                        ...
                        KLine500ScoreCalc.CalcKLineHistoryList(model350, Hou3Select500YiLouSetFormScoreAndChuShouBusiness.AllCode, (int)numericUpDown5.Value + 21);
        ...
        private void RemoveRecord(Hou3Select500_ZhouQiZhongScore record)
        {
            if (record != null)
            {
                Hou3Select500YiLouSetFormScoreAndChuShouBusiness.currentNeedCalcList.Remove(record);
            }
        ...
        private void btnYiLou_Click(object sender, EventArgs e)
        {
            ...
            if (Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List.Count >= 350)
            {
