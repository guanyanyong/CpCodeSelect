...
{
    public partial class MoniRunZhouQiZhong500Score4ge3AfterZhong : Form
    {
        private static Object lockObj = new object();
        private Hou3Select500YiLouSetFormZhouQiZhongScore4ge3AfterZhongMoniBusiness moniBusiness;
        Code beforeCode = null;
        Code currentCode = null;
        private Hou3Select500YiLouSetFormScoreAndChuShou parentForm = null;
        private int TryCopTime = 0;
        public MoniRunZhouQiZhong500Score4ge3AfterZhong(Hou3Select500YiLouSetFormScoreAndChuShou form) : this()
        {
            parentForm = form;
        }
        public MoniRunZhouQiZhong500Score4ge3AfterZhong()
        {
            InitializeComponent();
            moniBusiness = new Hou3Select500YiLouSetFormZhouQiZhongScore4ge3AfterZhongMoniBusiness(CustomLogMethod, Hou3Select500YiLouSetFormScoreAndChuShouBusiness.model350List);
        ...
        private void RunCode(Code code)
        {
            ...
            if (beforeCode == null || beforeCode.CodeQiHao != code.CodeQiHao)
            {
                ...
                //这里需要跑10期后再进行计算
                if (Hou3Select500YiLouSetFormScoreAndChuShouBusiness.AllCode.Count >= 270)
                {
