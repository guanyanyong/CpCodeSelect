...
using CpCodeSelect.Business.Score500.Moni;
...
{
    public partial class MoniRunZhouQiZhong500ZiRanGenerate4ge3AfterZhong : Form
    {
        private static Object lockObj = new object();
        private Hou3Select5004ge3AfterZhongZiRanGenerateMoniBusiness moniBusiness;
        Code beforeCode = null;
        Code currentCode = null;
        private Hou3Select500YiLouSetFormZiRanGenerate parentForm = null;
        private int TryCopTime = 0;
        public MoniRunZhouQiZhong500ZiRanGenerate4ge3AfterZhong(Hou3Select500YiLouSetFormZiRanGenerate form) : this()
        {
            parentForm = form;
        }
        public MoniRunZhouQiZhong500ZiRanGenerate4ge3AfterZhong()
        {
            InitializeComponent();
            moniBusiness = new Hou3Select5004ge3AfterZhongZiRanGenerateMoniBusiness(CustomLogMethod, Hou3Select500ZiRanGenerateBusiness.model500List);
        ...
        private void RunCode(Code code)
        {
            ...
            if (beforeCode == null || beforeCode.CodeQiHao != code.CodeQiHao)
            {
                ...
                //这里需要跑10期后再进行计算
                if (Hou3Select500ZiRanGenerateBusiness.AllCode.Count >= 270)
                {
        ...
        {
            TryCopTime = 0;
            txt350Code.Text = string.Join(" ", moniBusiness.currentSelect.Number500);
            CopyCurrent350Code();
        }
