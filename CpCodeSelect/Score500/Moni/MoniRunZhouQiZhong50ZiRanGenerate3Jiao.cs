...
{
    public partial class MoniRunZhouQiZhong50ZiRanGenerate3Jiao : Form
    {
        private static Object lockObj = new object();
        private Hou3Select500ZiRanGenerate3JiaoMoniBusiness moniBusiness;
        Code beforeCode = null;
        Code currentCode = null;
        private Hou2Select50YiLouSetFormZiRanGenerate3Jiao parentForm = null;
        private int TryCopTime = 0;
        public MoniRunZhouQiZhong50ZiRanGenerate3Jiao(Hou2Select50YiLouSetFormZiRanGenerate3Jiao form) : this()
        {
            parentForm = form;
        }
        public MoniRunZhouQiZhong50ZiRanGenerate3Jiao()
        {
            InitializeComponent();
