...
{
    public partial class MoniRunZhouQiZhong500ZiRanGenerate3Jiao : Form
    {
        private static Object lockObj = new object();
        private Hou3Select500ZiRanGenerate3JiaoMoniBusiness moniBusiness;
        Code beforeCode = null;
        Code currentCode = null;
        private Hou3Select500YiLouSetFormZiRanGenerate3Jiao parentForm = null;
        private int TryCopTime = 0;
        public MoniRunZhouQiZhong500ZiRanGenerate3Jiao(Hou3Select500YiLouSetFormZiRanGenerate3Jiao form) : this()
        {
            parentForm = form;
        }
        public MoniRunZhouQiZhong500ZiRanGenerate3Jiao()
        {
            InitializeComponent();
            moniBusiness = new Hou3Select500ZiRanGenerate3JiaoMoniBusiness(CustomLogMethod, Hou3Select500ZiRanGenerateBusiness.model500List);
