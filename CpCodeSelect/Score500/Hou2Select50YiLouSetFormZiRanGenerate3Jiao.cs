...
using CpCodeSelect.Model.CacheModel;
using Newtonsoft.Json.Serialization;
using System.Drawing.Imaging;
using System.Text.RegularExpressions;
using static System.Windows.Forms.VisualStyles.VisualStyleElement.ProgressBar;
using CpCodeSelect.Score500.Moni;
using CpCodeSelect.Business.Score500;
using CpCodeSelect.Util.Scorer500;

namespace CpCodeSelect.Score500
{
    public partial class Hou2Select50YiLouSetFormZiRanGenerate3Jiao : Form
    {
        ...
        */
        ...
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni35ge1;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moniRunZhouQiZhongScore3ge5AfterZhong;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moniRunZhouQiZhongLianXu8;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moniRunZhouQiZhongLianXu3;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moniRunZhouQiZhongScoreAllChuShou;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao sangesanyilou0;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moniRunZhouQiZhong3Ge3;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni1;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni2;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni3;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni4;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni5;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni6;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni6ge6;
        private MoniRunZhouQiZhong50ZiRanGenerate3Jiao moni6ge6a;
        ...
        private Hou3Select500_ZhouQiZhongScore currentCalcKLineDate = null;

        public static List<Exception> ExceptionList = new List<Exception>();
        // 从多少条记录后开始中了就删除记录 
        int zhongHouDelete = 1500;
        public Hou2Select50YiLouSetFormZiRanGenerate3Jiao()
        {
            InitMoni();
            InitializeComponent();
            Init();
        ...
        private void InitData()
        {
            ...
            Hou3Select500ZiRanGenerateBusiness.InitData();
        }
        ...
        private void InitMoni()
        {
            ...
            */
            ...
            moni6ge6a = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moni35ge1 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);

            moniRunZhouQiZhongScore3ge5AfterZhong = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moniRunZhouQiZhongLianXu8 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moniRunZhouQiZhongLianXu3 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moniRunZhouQiZhongScoreAllChuShou = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            sangesanyilou0 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moniRunZhouQiZhong3Ge3 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moni1 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moni2 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moni3 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
            moni4 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao (this);
            moni5 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao (this);
            moni6 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);


            moni6ge6 = new MoniRunZhouQiZhong50ZiRanGenerate3Jiao(this);
        ...
        public async Task<bool> ReadFirstLineAndCheck(int number = 1)
        {
            var record = number;
            Code code = null;
            string firstRecord = string.Empty;
            ...
            try
            {
                firstRecord = FileUtil.ReadFileFirstRecord(filePath, 1);
                code = FileAnalysis.GetCodeByStr(firstRecord);

                //把号码添加到缓存中
                if (code != null)
                {
                    await AddCodeToCache(code);
                }
            }
            catch (Exception)
            {
        ...
        public async void AsyncToCache()
        {
            var codeStrList = FileUtil.ReadFileAllRecods(filePath, 10000);
            var codeList = FileAnalysis.GetCodeListByCodeListStr(codeStrList);
            if (codeList != null && codeList.Count > 0)
        ...
        public void AnalySisCode(Code code, bool zhongHouDelete = false)
        {
            ...
            Hou3Select500ZiRanGenerateBusiness.InitCode(code, zhongHouDelete);
            InitOfferNumber();
            GenerateOfferNumber();
            SetForm();
        ...
        {
            var needAddList = Hou3Select500ZiRanGenerateBusiness.model500List.Where(p => p.NeedZhong == false && p.GuaCount >= boFangYanhuaCount).OrderByDescending(p => p.GuaCount).ToList();
            ...
            if (needAddList.Count > 0)
            {
                foreach (var model in needAddList)
                {
                    ...
                    exModel.五十码 = string.Join(" ", model.Number500);
        ...
        private void SetFormInstance()
        {
            ...
            lock (Hou3Select500ZiRanGenerateBusiness.LockModel500List)
            {
                var list = Hou3Select500ZiRanGenerateBusiness.model500List;
                if (list.Count > 0)
                {
        ...
        {
            bool needPlay = false;
            if (Hou3Select500ZiRanGenerateBusiness.model500List.Count > 500)
            {
                ...
                lock (Lock7ge5File)
                {
                    using (var writer = new StreamWriter(fileName, true))
                    {
                        var list = Hou3Select500ZiRanGenerateBusiness.model500List.ToList().Where(p => p.NeedZhong == false).ToList();
                        if (list.Count > 0)
                        {
                            ...
                            {
                                needFlush = true;
                                Hou3Select500ZiRanGenerateBusiness.model500List.ToList().Where(p => p.GuaCount == maxNumber).ToList().ForEach(recode =>
                                {
                                    writer.WriteLine($"[{DateTime.Now:HH:mm:ss.fff}] 记录 #" + $"期号:{code.CodeQiHao},号码：{code.CodeNumber}，当前连挂次数{recode.GuaCount}，号码：{string.Join(" ", recode.Number500)}");
        ...
        private async Task<bool> AddCodeToCache(Code code)
        {
            ...
            var requestData = new
            {
                ...
                code = code.CodeNumber,  // 开奖号作为code字段
                cpsx = "txqqff"
            };
            ...
            // 调用API添加记录 - 使用POST方法
            HttpResponseMessage response = await httpClient.PostAsync("add_single_data", content);
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                // 检查响应中的message
                string message = responseObject.message ?? "未知响应";

                //MessageBox.Show($"添加结果：{message}", "成功", MessageBoxButtons.OK, MessageBoxIcon.Information);
                AddRecord($"添加到url中的结果是:{message}");
        ...
        private async void ReadFirstLineExec()
        {
        ...
        private async void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && dataGridView1.Columns[e.ColumnIndex].Name == "Numer50")
            {
                ...
                if (row.DataBoundItem is Hou3Select500_ZhouQiZhongScore)
                {
                    ...
                    //    toNumberstr = string.Join(" ", model.Number500);
                    ...
                    try
                    {
                        ...
                        Clipboard.SetText(txt50Number.Text);
                        lblError.Text = "号码已拷贝";
            ...
            else if (e.RowIndex >= 0 && dataGridView1.Columns[e.ColumnIndex].Name == "Delete")
            {
                ...
                {
                    var model = row.DataBoundItem as Hou3Select500_ZhouQiZhongScore;
                    Hou3Select500ZiRanGenerateBusiness.model500List.Remove(model);
        ...
        private void BtnSelectClick()
        {
            ...
            var list = Hou3Select500ZiRanGenerateBusiness.model500List.Where(p => p.NeedZhong == false && p.ZhouQiZhongHouGua >= number).OrderByDescending(p => p.ZhouQiZhongHouGua).ThenByDescending(p => p.IsZhouQiZhongHou).ToList();
            var number2 = numericUpDown2.Value;
            var guaCount = numericUpDown3.Value;
            if (number2 >= 0 && number <= number2)
            {
                list = Hou3Select500ZiRanGenerateBusiness.model500List.Where(p => p.NeedZhong == false && p.ZhouQiZhongHouGua >= number && p.ZhouQiZhongHouGua <= number2).OrderByDescending(p => p.ZhouQiZhongHouGua).ThenByDescending(p => p.IsZhouQiZhongHou).ToList();
            }
            if (guaCount > -1)
            {
        ...
        private void SetDataSource(List<Hou3Select500_ZhouQiZhongScore> list)
        {
            dataGridView1.DataSource = list;
            lblResultCount.Text = list.Count.ToString();
            dataGridView1.AutoResizeColumns(DataGridViewAutoSizeColumnsMode.AllCells);
        ...
        {
            var hou3List = Hou3Select500ZiRanGenerateBusiness.GenerateHou3NumbereFromCode(270);
        ...
        private void btnTestCode_Click(object sender, EventArgs e)
        {
            ...
            Code code = Hou3Select500ZiRanGenerateBusiness.code;
            ...
            KLine156ScoreCalc.CalcKLineHistoryList(model350, Hou3Select500ZiRanGenerateBusiness.AllCode, 100);
            var result = KLine156ScoreCalc.KLineIsEnough(model350.KLineList);
            if (result.Result)
            {
                txtNum2.Text = "满足条件";
            }
        ...
        {
            var guaCount = numericUpDown3.Value;
            var list = Hou3Select500ZiRanGenerateBusiness.model500List.Where(p => p.NeedZhong == false && p.ZhouQiZhongHouGua == 0 && p.GuaCount == guaCount && p.IsZhouQiZhongHou).ToList();
            List<Hou3Select500_ZhouQiZhongScore> recordList = new List<Hou3Select500_ZhouQiZhongScore>();
            ...
            if (list.Count > 0)
            {
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    if (KLine156ScoreCalc.KLineIsEnough(klinLIst).Result)
                    {
                        foundRecord = true;
        ...
        private void DataLoadKLine()
        {
            if (currentCalcKLineDate == null)
            {
                ...
                {
                    //自动加载最新数据
                    var modelList = Hou3Select500ZiRanGenerateBusiness.model500List;
                    if (modelList != null && modelList.Count > 0)
                    {
                        foreach (var record in modelList)
                        {
                            ...
                            Hou3Select500ZiRanGenerateBusiness.currentNeedCalcList.Add(currentCalcKLineDate);
                ...
                else
                {
                    ...
                    {
                        Hou3Select500_ZhouQiZhongScore model350 = new Hou3Select500_ZhouQiZhongScore();
                        model350.Number500 = txtNumber.Split(' ').ToList();
                        model350.CodeNumber = Hou3Select500ZiRanGenerateBusiness.code.CodeNumber;
                        model350.CodeQiHao = Hou3Select500ZiRanGenerateBusiness.code.CodeQiHao;
                        ...
                        if (!string.IsNullOrEmpty(positonType))
                        {
                            ...
                            else if (positonType == "千")
                            {
                                model350.PositionType = PositionType.千;
                            }
                            else if (positonType == "百")
                            {
                                model350.PositionType = PositionType.百;
                            }
                            else if (positonType == "十")
                            {
                                model350.PositionType = PositionType.十;
                            }
                            else if (positonType == "个")
                            {
                                model350.PositionType = PositionType.个;
                            }
                        }
                        model350.NeedZhong = true;
                        model350.KLineList = new List<KLine156>();
                        model350.YiLouKline500 = new List<YiLouKline500>();
                        model350.YiLouTuLineList = new List<KLine156>();

                        KLine500ScoreCalc.CalcKLineHistoryList(model350, Hou3Select500ZiRanGenerateBusiness.AllCode, (int)numericUpDown5.Value + 21);
                        ...
                        if (model350.YiLouKline500.Count > 30)
                        {
        ...
        private void RemoveRecord(Hou3Select500_ZhouQiZhongScore record)
        {
            if (record != null)
            {
                Hou3Select500ZiRanGenerateBusiness.currentNeedCalcList.Remove(record);
            }

        }


        private void GenerateKLine(Hou3Select500_ZhouQiZhongScore data)
        {
            if (data.KLineList != null && data.KLineList.Count > 30)
            {
                var kline = data.KLineList[0];
                txtNum2.Text = $"加载数据成功,期号:{data.CodeQiHao},号码:{string.Join(" ", data.Number500)},K线日期:{kline.CodeQiHao}";

                textBox2.Text = string.Join(" ", data.Number500);
        ...
        private void GenerateYiLouKLine(Hou3Select500_ZhouQiZhongScore data)
        {
            if (data.YiLouKline500 != null && data.YiLouKline500.Count > 30)
            {
                var kline = data.YiLouKline500[0];
                //txtNum2.Text = $"加载数据成功,期号:{data.CodeQiHao},号码:{string.Join(" ", data.Number156)},K线日期:{kline.CodeQiHao}";

                textBox2.Text = string.Join(" ", data.Number500);

                var KlinList = new List<LotteryData>();
                int count = 0;
                foreach (var k in data.YiLouKline500)
                {
                    count++;
                    if (count <= 20) continue;
                    if (k.Bolling != null)
        ...
        private void btnYiLou_Click(object sender, EventArgs e)
        {
            ...
            if (Hou3Select500ZiRanGenerateBusiness.model500List.Count >= 350)
            {
                foreach (var record in Hou3Select500ZiRanGenerateBusiness.model500List)
                {
            ...
            //List<Hou3Select156_ZhouQiZhong> recordList = new List<Hou3Select156_ZhouQiZhong>();
        ...
        private void btnScore_Click(object sender, EventArgs e)
        {
            ...
            if (Hou3Select500ZiRanGenerateBusiness.model500List.Count >= 170)
            {
                foreach (var record in Hou3Select500ZiRanGenerateBusiness.model500List)
                {
            ...
            if (Hou3Select500ZiRanGenerateBusiness.model500List.Count >= 170)
            {
                foreach (var record in Hou3Select500ZiRanGenerateBusiness.model500List)
                {
...

                    {
                        ...
                        var yilouk3 = kLine500[kLine500.Count - 3];
                        var yilouk4 = kLine500[kLine500.Count - 4];
                        var yilouk5 = kLine500[kLine500.Count - 5];
                        var yilouk6 = kLine500[kLine500.Count - 6];

                        if (yilouk1.YiLouGuaCount == 0 && yilouk2.YiLouGuaCount == 1
                            && yilouk3.YiLouGuaCount == 0 && yilouk4.YiLouGuaCount == 1
                            && yilouk5.YiLouGuaCount == 0 && yilouk6.YiLouGuaCount == 1
                            )
                        {
                            getEnoughRecordList.Add(record);
                        }
        ...
        private void btnTest500_Click(object sender, EventArgs e)
        {
            var hou3List = Hou3Select500ZiRanGenerateBusiness.GenerateHou3NumbereFromCode(270);
            var list = Generate350Code.Generate(hou3List);
