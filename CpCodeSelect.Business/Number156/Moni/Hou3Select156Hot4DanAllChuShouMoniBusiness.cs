...
namespace CpCodeSelect.Business.Number156.Moni
{
    /// <summary>
    /// 模拟执行8个1轮的确认点买入
    /// </summary>
    public class Hou3Select156Hot4DanAllChuShouMoniBusiness
    {
        ...
        public Hou3Select156Hot4DanAllChuShouMoniBusiness(LogDelegate logMethod, List<Hou3Select350_ZhouQiZhongScore> model350List)
        {
        ...
        public void CalcCode(Code code, bool zhongHouDelete = false)
        {
            ...
            {
                model350List = Hou3Select156Hot4DanBusiness.model350List;
            }
        ...
        public void Select350AndStartCalc(Code code, bool zhongHouDelete = false)
        {
            ...
            getEnoughRecordList = Hou3Select156Hot4DanBusiness.model350List.ToList();
            if (getEnoughRecordList.Count <= 0) return;
            var record = getEnoughRecordList[0];
