...
{
    public static class Hou2Select50YiLouSetForm3guashangBusiness
    {
        ...
        public static List<Hou2Select50YiLouSetForm3guashangModel> modelList = new List<Hou2Select50YiLouSetForm3guashangModel>();
        ...
        public static void RemoveOldModel(int guaCount = 1)
        {
            ...
            List<Hou2Select50YiLouSetForm3guashangModel> removeList = new List<Hou2Select50YiLouSetForm3guashangModel>();
            int count = 0;
                        ...
                        */
                        ...
                        foreach (var number in numerList)
                        {
                            if (number.Count > 0)
                            {
                                ...
                                Hou2Select50YiLouSetForm3guashangModel model = new Hou2Select50YiLouSetForm3guashangModel();
                                model.Number50 = list;
