...
namespace CpCodeSelect.Business
{
    ...
    /// 模拟执行1个8的确认点买入
    /// </summary>
    public class Hou3Select350YiLouSetFormZhouQiZhongXiaJiangXiaoFanTanLianXu6MoniBusiness
    {
        ...
        public Hou3Select350YiLouSetFormZhouQiZhongXiaJiangXiaoFanTanLianXu6MoniBusiness(LogDelegate2 logMethod, List<Hou3Select350_ZhouQiZhong> model350List, Hou3Select350YiLouSetFormZhongParentBusiness business)
        {
