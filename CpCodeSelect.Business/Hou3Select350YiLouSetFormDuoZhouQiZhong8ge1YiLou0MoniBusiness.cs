...
namespace CpCodeSelect.Business
{
    ...
    /// 模拟执行4个2轮的确认点买入
    /// </summary>
    public class Hou3Select350YiLouSetFormDuoZhouQiZhong8ge1YiLou0MoniBusiness
    {
        ...
        public Hou3Select350YiLouSetFormDuoZhouQiZhong8ge1YiLou0MoniBusiness(LogDelegate logMethod, List<Hou3Select350_ZhouQiZhong> model350List)
        {
