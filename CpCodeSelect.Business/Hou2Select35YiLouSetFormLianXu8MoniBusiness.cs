...
namespace CpCodeSelect.Business
{
    ...
    /// 模拟执行1个6
    /// </summary>
    public class Hou2Select35YiLouSetFormLianXu8MoniBusiness
    {
        ...
        public Hou2Select35YiLouSetFormLianXu8MoniBusiness(LogDelegate logMethod, List<Hou2Select35Model> model35List)
        {
