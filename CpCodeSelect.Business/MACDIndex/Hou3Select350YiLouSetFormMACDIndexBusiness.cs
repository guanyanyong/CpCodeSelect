...
{
    public class Hou3Select350YiLouSetFormMACDIndexBusiness : Hou3Select350YiLouSetFormZhongParentBusiness
    {
        /// <summary>
        /// 评分对象列表
        /// </summary>
        ...
        public static new void InitCode(Code code, bool zhongHouDelete = false)
        {
            ...
            Hou3Select350YiLouSetFormMACDIndexBusiness.code = code;
        }
        /// <summary>
        ///  删除小于指定挂数的旧记录
        /// </summary>
