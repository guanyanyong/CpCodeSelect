...
namespace CpCodeSelect.Business.Score.Moni
{
    ...
    /// 模拟执行8个1轮的确认点买入
    /// </summary>
    public class MoniRunZhouQiZhongScore156AllChuShou2MoniBusiness
    {
        ...
        public MoniRunZhouQiZhongScore156AllChuShou2MoniBusiness(LogDelegate logMethod, List<Hou3Select156_ZhouQiZhongScore> model350List)
        {
        ...
        public void Select156AndStartCalc(Code code, bool zhongHouDelete = false)
        {
            if (IsTouZhuing && currentExecute != null && !string.IsNullOrEmpty(currentExecute.CodeQiHao))
            {
                ...
                var isZhong = currentExecute.Number156.Contains(housanStr);
