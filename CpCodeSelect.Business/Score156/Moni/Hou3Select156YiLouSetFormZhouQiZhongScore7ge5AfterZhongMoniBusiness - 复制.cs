...
namespace CpCodeSelect.Business.Score.Moni
{
    ...
    /// 模拟执行6个6轮的确认点买入
    /// </summary>
    public class Hou3Select156YiLouSetFormZhouQiZhongScore7ge5AfterZhongMoniBusiness   
    {
        ...
        private const int TotalQiCount = 35;
        
        public Hou3Select156YiLouSetFormZhouQiZhongScore7ge5AfterZhongMoniBusiness(LogDelegate logMethod, List<Hou3Select156_ZhouQiZhongScore> model350List)
        {
