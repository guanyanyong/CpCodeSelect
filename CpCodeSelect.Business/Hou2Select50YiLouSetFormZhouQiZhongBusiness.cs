...
{
    public static class Hou2Select50YiLouSetFormZhouQiZhongBusiness
    {
        ...
        public static void RemoveOldModel(Code code, int guaCount = 4)
        {
            ...
            List<Hou2Select50_ZhouQiZhong> removeList = new List<Hou2Select50_ZhouQiZhong>();
            int count = 0;
                            ...
                            */
                            ...
                            foreach (var number in numerList)
                            {
                                if (number.Count > 0)
                                {
                                    ...
                                    Hou2Select50_ZhouQiZhong model = new Hou2Select50_ZhouQiZhong();
                                    model.Number50 = list;
