...
namespace CpCodeSelect.Business.Score500.Moni
{
    ...
    /// 模拟执行6个6轮的确认点买入
    /// </summary>
    public class Hou3Select5004ge3AfterZhongZiRanGenerateMoniBusiness
    {
        ...
        public Hou3Select5004ge3AfterZhongZiRanGenerateMoniBusiness(LogDelegate logMethod, List<Hou3Select500_ZhouQiZhongScore> model500List)
        {
        ...
        public void CalcCode(Code code)
        {
            ...
            else
            {
                ...
                if (IsRunning)
                {
                    ...
                    if (currentSelect.Number500.Contains(housanStr))
                    {
                        //执行中,中出
                        TotalZhong++;
                        //中了以后 设置当前号码为未选中
