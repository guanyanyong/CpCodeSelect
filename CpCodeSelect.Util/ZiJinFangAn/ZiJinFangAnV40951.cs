...
{
    public class ZiJinFangAnV40951
    {
        #region 构造方法
        public ZiJinFangAnV40951()
        {
        ...
        public ZiJinFangAnV40951(decimal initialPrincipal, decimal currentPrincipal)
        {
        ...
        /// 当前执行轮次-Small-每倍投注金额
        /// </summary>
        public const decimal SmallPerBetAmount = 0.005M;
        public const decimal SmallPerBetAmountZhong = 0.00489M;
        /// <summary>
        ...
        /// <param name="geshu">中奖个数</param>
        /// <returns></returns>
        public KaiJiangResult SmallKaiJiang(bool isZhong,int geshu=0)
        {
            ...
            else
            {
                ...
                if (geshu > 1)
                {
                    //如果个数超过了1个,每个中奖需要加上倍数乘以0.989M的中奖金额
                    SmallCurrentPrincipal += (geshu - 1) * SmallCurrentBetAmount * (SmallPerBetAmountZhong + SmallPerBetAmount);
                }
