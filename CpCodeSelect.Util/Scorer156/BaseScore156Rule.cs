...
namespace CpCodeSelect.Util.Scorer
{
    ...
    /// 评分规则接口
    /// </summary>
    public interface IScore156Rule
    {
        string RuleName { get; }
    ...
    /// 抽象评分规则基类
    /// </summary>
    public abstract class BaseScore156Rule : IScore156Rule
    {
    ...
    /// 评分引擎
    /// </summary>
    public class Scoring156Engine
    {
        private List<IScore156Rule> _rules;

        public Scoring156Engine()
        {
            _rules = new List<IScore156Rule>();
        }

        public void AddRule(IScore156Rule rule)
        {
            _rules.Add(rule);
        }

        public void RemoveRule(IScore156Rule rule)
        {
            _rules.Remove(rule);
        }
