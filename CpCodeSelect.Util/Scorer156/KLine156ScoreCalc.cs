    ...
    public class KLine156ScoreCalc
    {
                ...
                if (HistoryData.Count >= 1) // 至少有1期历史数据
                {
                    ...
                    if (lastBigGapIndex >= 0)
                    {
                        ...
                        if (firstWinAfterGap >= 0)
                        {
                            ...
                            bool isInCycle = currentData.YiLouValue <= 5 && periodsSinceFirstWin <= 6;
        ...
        private static void CheckTrendSegment(LotteryScoreData currentData, Hou3Select156_ZhouQiZhong model)
        {
            ...
            if (latestBigGapIndex >= 0)
            {
                ...
                if (currentData.IsZhongJiang && currentData.YiLouValue <= 5)
                {
                    winsAfterBigGap++;
                }
                ...
                bool isWithinTheoryPeriod = currentData.YiLouValue <= 5;
