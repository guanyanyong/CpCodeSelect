...
namespace CpCodeSelect.Util.Scorer156.Rules
{
    public class KValueBelowMiddleNoBet156Rule : BaseScore156Rule
    {
    ...
    /// 趋势段形成后不可投注评分规则
    /// </summary>
    public class TrendSegmentNoBet156Rule : BaseScore156Rule
    {
    ...
    /// 确认点后趋势段未形成评分规则
    /// </summary>
    public class ConfirmPointBeforeTrend156Rule : BaseScore156Rule
    {
    ...
    /// 大遗漏间0遗漏强或1遗漏强评分规则
    /// </summary>
    public class BigGapBetweenZeroOrOneStrong156Rule : BaseScore156Rule
    {
    ...
    /// 三轨同向评分规则
    /// </summary>
    public class ThreeTrackSameDirection156Rule : BaseScore156Rule
    {
    ...
    /// 两轨同向评分规则
    /// </summary>
    public class TwoTrackSameDirection156Rule : BaseScore156Rule
    {
    ...
    /// 轨道反向评分规则
    /// </summary>
    public class TrackOppositeDirection156Rule : BaseScore156Rule
    {
    ...
    /// K值突破中轨未触碰上轨评分规则
    /// </summary>
    public class KValueBreakMiddleNotTouchUpper156Rule : BaseScore156Rule
    {
    ...
    /// </summary>
    public class KValueNearUpperRail156Rule : BaseScore156Rule
    {
    ...
    /// </summary>
    public class YiLouValue156Rule : BaseScore156Rule
    {
    ...
    /// </summary>
    public class BollingerUpperDecline156Rule : BaseScore156Rule
    {
    ...
    /// </summary>
    public class ContinuousChuShouLimit156Rule : BaseScore156Rule
    {
    ...
    /// </summary>
    public class SecondChuShouLimit156Rule : BaseScore156Rule
    {
    ...
    /// </summary>
    public class StopAfterWin156Rule : BaseScore156Rule
    {
    ...
    /// </summary>
    public class OpeningHorn156Rule : BaseScore156Rule
    {
