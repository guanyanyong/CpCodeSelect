...
{
    public class MultiThreadedNumberSelectFor500Hou3ZiRanGenerate
    { 
            ...
            int groupCount = 50)
        {
            ...
            //{
                ...
                Parallel.For(0, groupCount, new ParallelOptions { MaxDegreeOfParallelism = 1 }, i =>
                {
                    ...
                    // 生成一组号码
                    var group = GenerateSingleGroupFor500(localRandom,codeHou3List);
        ...
        /// <returns></returns>
        private static List<string> GenerateSingleGroupFor500(
            Random random,
            List<string> codeHou3List)
        {
            return Generate500CodeZiRan.Generate(codeHou3List,random);
        }
        /// <summary>
        /// 生成单组号码（50个）
        /// </summary>
