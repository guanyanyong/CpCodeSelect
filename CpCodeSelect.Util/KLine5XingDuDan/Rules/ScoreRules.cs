...
namespace CpCodeSelect.Util.KLine5XingDuDan.Rules
{
    public class KValueBelowMiddleNoBet40951Rule : BaseScore40951Rule
    {
    ...
    /// 趋势段形成后不可投注评分规则
    /// </summary>
    public class TrendSegmentNoBet40951Rule : BaseScore40951Rule
    {
    ...
    /// 确认点后趋势段未形成评分规则
    /// </summary>
    public class ConfirmPointBeforeTrend40951Rule : BaseScore40951Rule
    {
    ...
    /// 大遗漏间0遗漏强或1遗漏强评分规则
    /// </summary>
    public class BigGapBetweenZeroOrOneStrong40951Rule : BaseScore40951Rule
    {
    ...
    /// 三轨同向评分规则
    /// </summary>
    public class ThreeTrackSameDirection40951Rule : BaseScore40951Rule
    {
    ...
    /// 两轨同向评分规则
    /// </summary>
    public class TwoTrackSameDirection40951Rule : BaseScore40951Rule
    {
    ...
    /// 轨道反向评分规则
    /// </summary>
    public class TrackOppositeDirection40951Rule : BaseScore40951Rule
    {
    ...
    /// K值突破中轨未触碰上轨评分规则
    /// </summary>
    public class KValueBreakMiddleNotTouchUpper40951Rule : BaseScore40951Rule
    {
    ...
    /// </summary>
    public class KValueNearUpperRail40951Rule : BaseScore40951Rule
    {
    ...
    /// </summary>
    public class YiLouValue40951Rule : BaseScore40951Rule
    {
    ...
    /// </summary>
    public class BollingerUpperDecline40951Rule : BaseScore40951Rule
    {
    ...
    /// </summary>
    public class ContinuousChuShouLimit40951Rule : BaseScore40951Rule
    {
    ...
    /// </summary>
    public class SecondChuShouLimit40951Rule : BaseScore40951Rule
    {
    ...
    /// </summary>
    public class StopAfterWin40951Rule : BaseScore40951Rule
    {
    ...
    /// </summary>
    public class OpeningHorn40951Rule : BaseScore40951Rule
    {
